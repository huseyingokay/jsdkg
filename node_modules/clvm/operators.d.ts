...
export declare function args_len(op_name: string, args: SExp): Generator<number, void, unknown>;
export declare function default_unknown_op(op: Bytes, args: SExp): Tuple<number, CLVMType>;
...
declare type TAtomOpFunctionMap<A extends string = ATOMS> = Record<A, TOpFunc> & Partial<Record<TBasicAtom, Bytes>>;
export declare type TOperatorDict<A extends string = ATOMS> = {
    unknown_op_handler: typeof default_unknown_op;
} & ((op: Bytes | string | number, args: SExp) => Tuple<number, CLVMType>) & TAtomOpFunctionMap<A> & Record<TBasicAtom, Bytes>;
export declare type TOperatorDictOption = {
    quote_atom: Bytes;
    apply_atom: Bytes;
    unknown_op_handler: typeof default_unknown_op;
};
export declare function OperatorDict<A extends string = ATOMS>(atom_op_function_map: TAtomOpFunctionMap<A> | TOperatorDict, option?: Partial<TOperatorDictOption>): TOperatorDict<A>;
